	...
	for _, tc := range []struct {
		...
		},
		{
			...
			expectedStr: joinLines(
				...
				"\tNodes   []*UnexpectedElement `xml:\",any\"`",
				"\tXMLName xml.Name",
				`}`,
				``,
				`type A struct {`,
		...
		{
			name: "unexpected_elements_named_types",
			options: []xmlstruct.GeneratorOption{
				xmlstruct.WithNamedTypes(true),
				xmlstruct.WithSupportUnexpectedElements(true),
			},
		...
		{
			name: "unexpected_elements_named_types_custom_name",
			options: []xmlstruct.GeneratorOption{
				xmlstruct.WithNamedTypes(true),
				xmlstruct.WithSupportUnexpectedElements(true),
				xmlstruct.WithUnexpectedElementTypeName("MyType"),
